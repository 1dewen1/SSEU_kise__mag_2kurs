...
namespace ConsoleRectangle
{
        ...
        class Rectangle
        {
            public double x1, x2; //верхний левый угол
            public double y1, y2; //правый нижний угол
            ...
            //изменить высоту
            public void SetHeigtht(double newHeigtht)
            {
                y2 = y1 + newHeigtht;
            }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Периметр = " + r.S());
                //меню
                Console.WriteLine("\t\t\t╔═══════════════════════════════╗");
